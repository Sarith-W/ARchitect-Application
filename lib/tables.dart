                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/table1Img.png"),
                          ),
                        );
                      },
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/table2Img.png"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/table3Img.png"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/table4Img.png"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/table5Img.png"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
