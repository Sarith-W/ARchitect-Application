                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/sofa1Img.jpg"),
                          ),
                        );
                      },
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/sofa2Img.jpg"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/sofa3Img.jpg"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/sofa4Img.jpg"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const Customize("assets/images/sofa5Img.jpg"),
                          ),
                        );
                      },
                      child: buildImageStack(context, sizedBoxHeight,
